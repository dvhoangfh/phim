				      ...
				      <div class="movie-browse-agile">
						...
						<div class="browse-agile-w3ls general-w3ls">
								<div class="tittle-head">
									<h4 class="latest-text">Phim {{ $data_quocgia-> ten_quocgia}} </h4>
								</div>
								<div class="container">
									<!-- /latest-movies1 -->	
							    <div class="browse-inner-come-agile-w3">
									...
									<div class="col-md-2 w3l-movie-gride-agile">
										<a href="@if($val->phimbo == 1)
												...
												@endif" class="hvr-shutter-out-horizontal"><img src="{{ $val->img_phim }}" title="{{ $val->ten_phim }}" width="182px" height="268px" alt=" " />
										    <div class="w3l-action-icon"><i class="fa fa-play-circle" aria-hidden="true"></i></div>
										</a>
										<div class="mid-1">
											<div class="w3l-movie-text">
												<h6 class="textlimit"><a title="{{ $val->ten_phim }}" href="
												@if($val->phimbo == 1)
													{{route('welcome.xemphim',$val->slug.'-tap-1-'.$val->id)}}
												@else
													{{route('welcome.xemphim',$val->slug.'-'.$val->id)}}
